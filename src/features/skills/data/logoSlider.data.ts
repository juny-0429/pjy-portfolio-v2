export const logos = [
  { id: 1, src: '/assets/images/logos/typescript-logo.png', alt: 'TypeScript Logo' },
  { id: 2, src: '/assets/images/logos/nextjs-logo.png', alt: 'Next.js Logo' },
  { id: 3, src: '/assets/images/logos/react-logo.png', alt: 'React Logo' },
  { id: 4, src: '/assets/images/logos/vue-logo.png', alt: 'Vue.js Logo' },
  { id: 5, src: '/assets/images/logos/javascript-logo.png', alt: 'JavaScript Logo' },
